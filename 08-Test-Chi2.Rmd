...
library(janitor)
chisq.test(cb_tab$n, p = c(1/2, 1/2), rescale.p = FALSE)
```
...
Afin de vous aider dans la recherche d'indices intéressants et pertinents, de documents sont mis à votre disposition via le lien suivant:
