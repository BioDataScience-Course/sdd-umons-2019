...
<ul>
<li>Processeur : à 2 coeurs / 4 threads d'une vitesse de calcul suffisante (<a href="https://novabench.com/parts/cpu">score CPU Novabench</a> d'environ 700).</li>
...
### Conseils pour acheter un ordinateur
...
L'élément le plus important étant la vitesse de calcul du processeur, obtenez la référence du processeur de l'ordinateur que vous convoitez et recherchez-le [ici](https://novabench.com/parts/cpu). Comparer alors son score à notre configuration de référence, et faites-en de même pour les autres caractéristiques (mémoire vive, type et taille du disque dur, etc.)
...
| [MacBook Pro 13''](https://www.lesnumeriques.com/ordinateur-portable/apple-macbook-pro-13-pouces-2017-avec-touch-bar-p44179/test.html)            | Core i5-8259U [2/4] (???/10938)  | 8Go     | SSD 256Go           | Intel Iris+640 | 13'' (2560x1600)   | 1.4kg  | 1750€ |
...
| [MacBook Pro 15''](https://www.lesnumeriques.com/ordinateur-portable/macbook-pro-15-2017-p39735/test.html)            | Core i7-8750H [6/12] (1400/12548) | 16Go    | SSD 512Go           | Radeon Pro 555X   | 15.4'' (2880x1800) | 1.83kg | 3000€ |
...
A titre de comparaison, l'équivalent chez Apple est également présenté (le MacBook Pro 15''). Ce dernier est à nouveau deux fois plus cher. Mais son écran est incomparable, sa finition est impeccable, et il tourne sous MacOS naturellement pour les afficionados ! Il n'a pas encore été testé chez "les numériques", mais [voici le test du modèle 2017](https://www.lesnumeriques.com/ordinateur-portable/macbook-pro-15-2017-p39735/test.html).
