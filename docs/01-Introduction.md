...
![Représentation des versions successives d'un projet avec GitHub.](images/github.png)
...
![Différentes versions d'un projet sur GitHub lorsque deux personnes différentes collaborent sur le même dépôt.](images/github1.png)
