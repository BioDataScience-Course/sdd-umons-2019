...
Il existe plusieurs programmes pour vous aider à cérer vos dépots sur GitHub. Nous avons décidé de vous présenter [GitHub Desktop](https://desktop.github.com). 
...
Nous avons débuté un projet sur RStudio configuré avec le gestionnaire de version. 
