...
```{r, fig.cap= "Histogramme de la longeur des sépales de 3 espèces d'iris."}
# Importation du jeu de données
...
```{r , fig.cap= "Histogramme de la longeur des sépales de 3 espèces d'iris en employant les facets comme argument pour discriminer les espèces."}
