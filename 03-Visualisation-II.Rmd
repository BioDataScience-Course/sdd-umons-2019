...
```{r , fig.cap= "Histogramme de la longueur des sépales de 3 espèces d'iris en employant les facettes pour séparer les espèces."}
...
```{r, fig.cap= "Histogramme de la longueur des sépales de 3 espèces d'iris avec facttes et histogrammes complets d'arrière plan en grisé."}
nbins <- 25
...
```{r, fig.cap="Diagramme en violon montrant la densité de tailles des 17 classes d'organismes planctoniques."}
...
```{r, fig.cap="Diagramme en violon montrant la densité de tailles des 17 classes d'organismes planctoniques avec l'ajout de la fonction `coord_flip()`."}
chart(data = zooplankton, size ~ class) +
  geom_violin() +
  coord_flip()
```
...
```{r, fig.cap="Diagramme en violon montrant la densité de tailles des 17 classes d'organismes planctoniques avec la fonction geom_density_ridges.", message=FALSE}
