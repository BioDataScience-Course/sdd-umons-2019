...
#knitr::kable(head(iris, 20), caption = 'Un exemple de tableau.',booktabs = TRUE)
```
...
```{r}
ble <- data::read("http://tinyurl.com/Biostat-Ble", type = "csv")
```
...
```{r}
ub <- data::read("urchin_bio", package = "data", lang = "fr")
ggtexttable(head(ub, n = 4), theme = ttheme("lBlack"))
```
