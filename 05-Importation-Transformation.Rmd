...
```{block2, type='bdd'}
Pour cette activité, vous allez **travailler seul** sur les données d'un projet étudiant la croissance des coraux.
...
```{block2, type='bdd'}
Réalisez dans le projet sur la biométrie humaine les exercies suivants : 
