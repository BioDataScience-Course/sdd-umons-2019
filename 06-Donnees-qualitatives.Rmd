...
* Pour les autres utilisateurs de ce livre, veuillez faire un "fork" du dépôt [sdd1_mmetagenomics](https://github.com/BioDataScience-Course/sdd1_metagenomics). Si vous souhaitez accéder à une version précédente de l'exercice, sélectionner la branche correspondante à l'année que vous recherchez.  
```
