...
```{block, type='bdd'}
Ce projet couvre toute la matière du module 12. Il y a 3 exercices pour les 3 parties de ce module.

- <https://classroom.github.com/a/sjzY0x-h>

Lisez attentivement le README. 

*Ce projet doit être terminé à la fin de ce module*
```
