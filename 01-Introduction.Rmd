...
```{block, type = 'bdd'}
Une fois connecté au compte `sv` dans la machine virtuelle, réalisez l'activité : **Découverte de RStudio et R Markdown**
<https://github.com/BioDataScience-Course/sdd_lesson/blob/master/sdd1_01/presentations/sdd1_01_markdown.pdf>

Après avoir réalisé l'activité, un document récapitulatif est mis à votre disposition : 
<https://github.com/BioDataScience-Course/sdd_lesson/blob/master/sdd1_01/exercises/sdd1_01_markdown.Rmd>
```
