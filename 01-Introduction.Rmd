...
<https://github.com/BioDataScience-Course/sdd_lesson/blob/master/sdd1_01/presentations/sdd1_01_19_svbox.pdf>

Après avoir réalisé l'activité, un document récapitulatif est mis à votre disposition : 
<https://htmlpreview.github.io/?https://github.com/BioDataScience-Course/sdd_lesson/blob/master/sdd1_01/exercises/sdd1_01_19_svbox_solution.html>
```
...
Pour le cours de Bio-informatique et science des données  : <https://classroom.github.com/a/GY_xtRk6>. 

Les instructions détaillées sont dans le fichier `README.md` sur ce dépôt.

Si vous n'êtes pas famillarisé avec github Classeroom;, vous pouvez vous référer au lien suivant :
<https://biodatascience-course.sciviews.org/sdd-umons/github-classroom.html>
