...
#  geom_qq() +
  #geom_qq_line() +
  #geom_abline(
  #  slope = diff(quantile(.$.std.resid[!is.na(.$.std.resid)], c(0.25, 0.75))) /
  #    diff(qnorm(c(0.25, 0.75))),
  #  intercept = quantile(.$.std.resid[!is.na(.$.std.resid)], 0.25) - .slope * qnorm(0.25),
  #    colour = "darkgray") +
#  labs(x = "Theoretical quantiles", y = "Standardized residuals") +
#  ggtitle("Normal Q-Q")
.anova2 <- broom::augment(.anova)
car::qqPlot(.anova2[[".std.resid"]], distribution = "norm",
...
```{r crabs1, fig.cap="Transformation tripe exponentielle du ratio largeur arrière/largeur max en fonction du groupe de crabes *L. variegatus*."}
