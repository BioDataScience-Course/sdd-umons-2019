...
chart(urchin,formula = height ~  weight) + 
  ...
  theme(axis.text.x = element_text(colour = "#a80039", size = 13), 
        axis.title.x = element_text(colour = "#029687", size = 13), 
        axis.text.y = element_text(colour = "#a80039", size = 13), 
        axis.title.y = element_text(colour = "#029687", size = 13),
