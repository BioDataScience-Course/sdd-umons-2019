...
```{r, fig.cap = "A) Variation de la hauteur [mm] en fonction de la masse [g] d'oursins violets. B) Variation du logarithme de la hauteur [mm] en fonction du logarithme de la masse [g] d'oursins violets "}
a <- chart(urchin,formula = height ~  weight) + 
  geom_point() +
  labs( y = "Hauteur du test [mm]", x = "Masse [g]")
