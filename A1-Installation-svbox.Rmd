...
```{block, type='note'}
Pour les étudiants de l'UMONS et ceux de Charleroi, vous ne _devez pas_ posséder votre propre ordinateur pour suivre le cours de science des données biologiques. Des ordinateurs en configuration de référence (voir [ordinateur](#ordi)) vous sont accessibles au cours et aux travaux pratiques, et en dehors des heures à la salle "Escher" (demander un accès au secrétariat des sciences). Toutefois, si vous pouvez acquérir un ordinateur personnel, cela vous apportera un confort et une flexibilité indéniable, **à condition de bien le choisir !**
```
