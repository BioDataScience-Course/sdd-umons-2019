...
```{r, fig.cap= "Dénombrement de l'occurence en fonction de la variable facteur `cut` et de la variable `clarity` du jeu de données `diamonds`."}
...
```{r, fig.cap= 'A) Graphique en barres (variable facteur `cut` et variable `clarity` avec `position = "dodge"`. B) Idem avec `position = "fill"`'}
