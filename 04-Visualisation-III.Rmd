...
```{r, fig.cap= " Graphique en barre du dénombrement de quatre variétés d'oursins. "}
chart(zooplankton, formula = ~ class) +
  geom_bar() +
  coord_flip()
```
...
```{r, fig.cap="Comparaison entre le graphique en barre et le nuage de point montrant tous les deux la taille moyenne en fonction des classes de copépodes."}
